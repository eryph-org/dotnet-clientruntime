...
namespace Haipa.ComputeClient.Models
{
    ...
    public partial class OperationTask
    {
        ...
        public OperationTask(System.Guid? id = default(System.Guid?), string status = default(string), string agentName = default(string), string name = default(string), Operation operation = default(Operation))
        {
            Id = id;
            Status = status;
            AgentName = agentName;
